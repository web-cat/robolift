/*==========================================================================*\
 |  $Id: PerlScoringJUnitResultFormatter.java,v 1.2 2010/02/23 17:19:18 stedwar2 Exp $
 |*-------------------------------------------------------------------------*|
    ...
    implements JUnitResultFormatter
{
    ...
    {
        alreadyLoggedFailureForTest = false;
        numExecuted = 0.0;
        numFailed   = 0.0;
    }
    ...
    {
        if (!alreadyLoggedFailureForTest)
        {
            numFailed += scoringWeightOf( test );
            alreadyLoggedFailureForTest = true;
        }
    }
    ...
    protected boolean alreadyLoggedFailureForTest()
    {
        return alreadyLoggedFailureForTest;
    }
    ...
    private boolean alreadyLoggedFailureForTest;
}
